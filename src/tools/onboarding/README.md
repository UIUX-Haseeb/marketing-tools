...
Layers: `public/tools/onboarding/background.png` (flattened navy gradient + circle pattern + upper gradient; the white "provident." wordmark is drawn from `public/tools/_shared/provident-wordmark-white.svg`, centred at the top) → new joiner's photo, cover-fit in the 622×897 box, clipped → `public/tools/onboarding/bottom-fade.png` (1080×515, fades the photo into the background) → fixed headline + sub text, name (Regular 42 white), designation (Regular 20.2 gold, caps).
